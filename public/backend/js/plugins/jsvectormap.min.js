!function (t, e) {
    ...
    var k = {
        ...
        var s = f(e), a = -1 === s.getAttribute("class").indexOf("jvm-region") ? "marker" : "region",
            n = "region" === a, r = n ? s.getAttribute("data-code") : s.getAttribute("data-index"),
    ...
    var L = function (e) {
        function i(t) {
            var i, s = t.index, a = t.map, n = t.style, r = t.x1, o = t.y1, h = t.x2, l = t.y2, c = t.group,
                u = t.config;
    ...
    var T = {
        _setupContainerEvents: function () {
            ...
            this.params.draggable && (S.on(this.container, "mousemove", (function (i) {
                ...
                var e = 75 * ((t.deltaY || -t.wheelDelta || t.detail) >> 10 || 1),
                    a = i.container.getBoundingClientRect(), n = t.pageX - a.left - window.pageXOffset,
            ...
            var t = this, e = m("div", "jvm-zoom-btn jvm-zoomin", "&#43;", !0),
            ...
            var i = G.maps[this.params.map].projection, s = E[i.type](t, e, i.centralMeridian), a = s.x, n = s.y,
        ...
        function i(t) {
            var i;
            return (i = e.call(this, "svg") || this)._container = t, i._defsElement = new z("defs"), i._rootElement = new z("g", {id: "jvm-regions-group"}), i.node.appendChild(i._defsElement.node), i.node.appendChild(i._rootElement.node), i._container.appendChild(i.node), i
        }
